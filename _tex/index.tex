...
\makeatother
\hypersetup{
  pdftitle={Start Strong: An Analysis of Motorsport Qualifying with RaceIndyCar{,} a Novel Python Package},
  pdfauthor={Anonymous},
...
\title{\bf Start Strong: An Analysis of Motorsport Qualifying with
RaceIndyCar, a Novel Python Package}
\author{
Anonymous\\
{[}Institution Name{]}\\
}
